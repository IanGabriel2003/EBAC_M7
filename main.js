...
form.addEventListener('submit', function(e){
    ...
    const numeroTotalA = Number(document.getElementById('A').value);
    const numeroTotalB = Number(document.getElementById('B').value);
    ...
    function validaNumero(numeroTotalA, numeroTotalB){
        ...
        const containerMensagemSucesso = document.querySelector('.certo');
        const containerMensagemError = document.querySelector('.errado');
